  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
        <MetricCard label={<Tip k="organic_traffic">Organic traffic</Tip>} value={fmt(overview.organic_traffic)} change={overview.traffic_change_pct ? `${overview.traffic_change_pct > 0 ? "+" : ""}${overview.traffic_change_pct}%` : undefined} positive={overview.traffic_change_pct > 0} />
