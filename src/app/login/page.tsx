      ...
      <div className="w-full max-w-sm">
        <div className="flex items-center gap-2 justify-center mb-8">
          <svg width="32" height="32" viewBox="0 0 32 32">
            <defs><linearGradient id="lgA" x1="0" y1="0" x2="32" y2="32" gradientUnits="userSpaceOnUse"><stop offset="0%" stopColor="#2563EB"/><stop offset="100%" stopColor="#06B6D4"/></linearGradient></defs>
            <rect width="32" height="32" rx="7" fill="url(#lgA)"/>
          ...
          {magicLinkSent ? (
            ...
            <>
              ...
              <button
                ...
                className="w-full text-center text-xs text-text-secondary hover:text-accent mt-3 transition-colors"
              >
